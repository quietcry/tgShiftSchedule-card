...
`;function Ve({left:e="",center:t="",right:i="",fullWidth:n=""}){return Z`
  ...
  `}function Ke(e,t,i){return(t=function(e){var t=function(e){if("object"!=typeof e||!e)return e;var t=e[Symbol.toPrimitive];if(void 0!==t){var i=t.call(e,"string");if("object"!=typeof i)return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return String(e)}(e);return"symbol"==typeof t?t:t+""}(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}class qe extends ge{constructor(){super(),this.calendars=[],this.selectedShortcut=null,this._validationErrors={}}connectedCallback(){super.connectedCallback(),this._updateValidationErrors()}updated(e){if(super.updated(e),e.has("calendars")){const t=e.get("calendars");if(console.log("[ConfigPanel] updated() aufgerufen mit calendars-Änderung",{oldCalendars:t?.length,newCalendars:this.calendars?.length,hasChanged:this.constructor.properties.calendars.hasChanged}),t&&t.length>0&&this.calendars&&this.calendars.length>0&&JSON.stringify(t)===JSON.stringify(this.calendars))return void console.log("[ConfigPanel] calendars: Update ignoriert (Daten identisch)");this._updateValidationErrors()}e.has("selectedShortcut")&&this._updateValidationErrors()}_validateCalendar(e){const t={};if(e.shortcut&&/^[a-z]$/.test(e.shortcut)||(t.shortcut=!0),e.timeRanges&&Array.isArray(e.timeRanges)){const i=[];e.timeRanges.forEach(((e,n)=>{const s="object"==typeof e&&e.times?e:{id:null,times:e||[null,null]};if(s.id&&/^[1-9]$/.test(s.id)){const e=parseInt(s.id);i.includes(e)?t[`timeRange_${n}_id`]=!0:i.push(e)}else t[`timeRange_${n}_id`]=!0;s.times&&s.times[0]&&!/^([0-1][0-9]|2[0-3]):[0-5][0-9]$/.test(s.times[0])&&(t[`timeRange_${n}_start`]=!0),s.times&&s.times[1]&&!/^([0-1][0-9]|2[0-3]):[0-5][0-9]$/.test(s.times[1])&&(t[`timeRange_${n}_end`]=!0)}))}return t}_hasValidationErrors(){if(!this.selectedShortcut)return!1;const e=this.calendars.find((e=>e.shortcut===this.selectedShortcut));if(!e)return!1;const t=this._validateCalendar(e);return Object.keys(t).length>0}_triggerColorPicker(e){const t=this.shadowRoot.querySelector('input[type="color"]');t&&t.click()}render(){const e=this.calendars.find((e=>e.shortcut===this.selectedShortcut)),t=this.calendars.findIndex((e=>e.shortcut===this.selectedShortcut));return Z`
    ...
    `]),window.customCards&&window.customCards.push({type:pe,name:me,description:"Eine Schichtplan-Karte für Arbeitszeiten",preview:!0}),!customElements.get(pe))try{customElements.define(pe,Ct)}catch(e){}})();
