                  ...
                  ${Ve({left:"",center:Z`
                    ...
                    `,right:Z`
                      <button
                        ...
                        @click=${e=>{e.stopPropagation(),e.preventDefault(),this._configPanelCalendars=JSON.parse(JSON.stringify(this._config?.calendars||[])),this._showConfigPanel=!0,this.requestUpdate()}}
        ...
        ${this._showConfigPanel?Z`
              <div class="config-wrapper">
                <shift-config-panel
                  ...
                  .hass=${this._hass}
                  @close=${()=>{this._showConfigPanel=!1,this._configPanelCalendars=null,this.requestUpdate()}}
